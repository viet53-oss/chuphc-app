          ...
          <div className="app-section !border-black bg-primary-tint p-1 m-1">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`rounded-full shadow-xl flex items-center justify-center transition-all ${isListening ? 'bg-red-500 scale-110 animate-pulse' : 'bg-white hover:scale-105'}`}
                style={{ width: '100px', height: '100px', touchAction: 'none' }}
                title={isListening ? 'Listening...' : 'Hold to speak'}
              >
                <img src="/mic-icon.png" alt="Microphone" className="w-16 h-16 object-contain" />
              </button>
            </div>
          </div>
